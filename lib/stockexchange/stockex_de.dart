    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Alert!'),
          content: Text(
            'ఒరిజినల్ ఆప్స్ లోనే ఇన్వెస్ట్ చెయ్యండి,ఫేక్ ఆప్స్ లో ఇన్వెస్ట్  చేసి మోసపోకండి. మీకు మొదట గా వచ్చిన అమౌంట్ కూడా  మీ  లాగే  మోసపోయిన ఇతరుల అకౌంట్ నుండి వచ్చినది. వాళ్ళు కంప్లయింట్ చేస్తే ఆ కేసు లో మీరు కూడా ముద్దాయిలు అవుతారు.',
            style: TextStyle(
              color: Colors.red,

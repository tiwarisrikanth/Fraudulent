                    ...
                    SizedBox(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          w(w: 10),
                          iconBox(
                              icon: Icons.support_agent_outlined, h: 40, w: 40)
                        ],
                      ),
                    )
                    //  top bar
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      smi(text: "See all", size: 14, color: Color(0xffE77706)),
                      Icon(
                        Icons.chevron_right,
                        size: 18,
                        color: Color(0xffE77706),
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (_, i) {
                    return Padding(
                      ...
                      child: Bounce(
                          onTap: () {
                            toScreen(context: context, page: MaidDetails(data: profiles[i],));
                          },
...
final List<Map<String, dynamic>> profiles = [
  ...
  },
  {
    ...
    'applicants': Random().nextInt(1000),
    'imageUrl': 'https://images.unsplash.com/photo-1519389950473-47ba0277781c', // Unsplash
  },
  {
    'title': 'Marketing Specialist',
    'applicants': Random().nextInt(1000),
    'imageUrl': 'https://images.unsplash.com/photo-1581092334497-f97272c0fe64', // Unsplash
  },
  {
    'title': 'Sales Executive',
    'applicants': Random().nextInt(1000),
    'imageUrl': 'https://images.unsplash.com/photo-1565728744381-225c5f633849', // Unsplash
  },
  {
    'title': 'HR Manager',
    'applicants': Random().nextInt(1000),
    'imageUrl': 'https://images.unsplash.com/photo-1581291518857-4e27b48ff24e', // Unsplash
  },
  {
    'title': 'Business Analyst',
    'applicants': Random().nextInt(1000),
    'imageUrl': 'https://images.unsplash.com/photo-1573164574391-4e0484c2f87d', // Unsplash
  },
];
...
class _ChatScreenState extends State<ChatScreen> {
  final List<Map<String, dynamic>> messages = [
    {'sender': 'Employer', 'text': 'You have done well. I would like to invite you to join our premium group.'},
    {'sender': 'Worker', 'text': 'What is the premium group about?'},
    {'sender': 'Employer', 'text': 'In the premium group, you will get access to exclusive projects and opportunities to earn more.'},
    {'sender': 'Worker', 'text': 'That sounds interesting! How can I join?'},
    {'sender': 'Employer', 'text': 'I will send you an invitation. Once you accept, you will be a part of the premium group and start earning more immediately.'},
    {'sender': 'Worker', 'text': 'What kind of projects will I be working on?'},
    {'sender': 'Employer', 'text': 'You will be working on high-priority projects that require advanced skills. These projects are often time-sensitive and highly rewarding.'},
    {'sender': 'Worker', 'text': 'Will there be any additional training or resources provided?'},
    {'sender': 'Employer', 'text': 'Yes, you will have access to exclusive training materials, webinars, and one-on-one mentoring sessions to help you excel.'},
    {'sender': 'Worker', 'text': 'How often are new projects assigned?'},
    {'sender': 'Employer', 'text': 'New projects are assigned on a weekly basis, depending on your availability and performance.'},
    {'sender': 'Worker', 'text': 'What are the payment terms for these premium projects?'},
    {'sender': 'Employer', 'text': 'Payments are made on a per-project basis, with higher rates than our regular projects. You can expect to earn significantly more.'},
    {'sender': 'Worker', 'text': 'Is there any contract or commitment required to join the premium group?'},
    {'sender': 'Employer', 'text': 'No long-term commitment is required. However, we do expect a high level of professionalism and dedication to the projects you undertake.'},
    {'sender': 'Worker', 'text': 'Thank you for the information. I am excited to join the premium group and start working on these projects.'},
    {'sender': 'Employer', 'text': 'Great! I will send over the invitation now. Welcome to the premium group!', },
        {'sender': 'Employer', 'text': 'https://web.whatsapp.com/prmiumgroup', 'isLink': true},
  ];
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          children: [
            CircleAvatar(
              backgroundImage: NetworkImage('https://randomuser.me/api/portraits/men/1.jpg'), // Random profile image
            ),
            SizedBox(width: 10),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
                ...
                return Padding(
                  ...
                  child: Align(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: isEmployer ? Colors.teal[100] : Colors.green[100],
                        borderRadius: BorderRadius.only(
                          topLeft: Radius.circular(10),
                          topRight: Radius.circular(10),
                          bottomLeft: isEmployer ? Radius.circular(0) : Radius.circular(10),
                          bottomRight: isEmployer ? Radius.circular(10) : Radius.circular(0),
                        ),
                      ),
                              ...
                              showDialog(
                                ...
                                builder: (BuildContext context) {
                                  return AlertDialog(
                                    ...
                                    content: Text('This invitation is a scam. Please do not accept it.'),
                                    actions: [
                                      TextButton(
                                        onPressed: () {

...
class EmailListScreen extends StatelessWidget {
  String pdfurl = "https://community.pepperdine.edu/studentemployment/content/job-offer-letter-template.pdf";
final List<Email> emails = [
  Email(
    ...
    time: "2:45 PM",
    pdfUrl: "https://community.pepperdine.edu/studentemployment/content/job-offer-letter-template.pdf",
...
class _ChatScreenState extends State<ChatScreen> {
  final List<Message> messages = [
    ...
    Message(sender: "HR", text: "Please deposit the joining fee of ₹15000 for further processing."),
    Message(sender: "HR", text: "Make it fast so that you can join as early as possible."),
    Message(sender: "HR", text: "Click on the button below to complete the process."),
  ];
  ...
  void _handlePaymentSuccess(PaymentSuccessResponse response) {
    setState(() {
      messages.add(Message(sender: "Candidate", text: "Hi mam, I have done payment."));
      messages.add(Message(sender: "Candidate", text: "Mam, please reply."));
      _showPayButton = false; // Hide button after payment
    });
    _scrollToBottom();
    Future.delayed(Duration(seconds: 5), () {
      if (messages.last.sender == "Candidate" && !messages.any((msg) => msg.sender == "HR" && msg.text.contains("Reply"))) {
        _showScamWarning();
      }
    });
  }
...
void _showScamWarning() {
  ...
  bool _shouldShowPayButton() {
    ...
    return messages.isNotEmpty &&
           ...
           messages.last.text.contains("Click on the button below to complete the process.");
  }
